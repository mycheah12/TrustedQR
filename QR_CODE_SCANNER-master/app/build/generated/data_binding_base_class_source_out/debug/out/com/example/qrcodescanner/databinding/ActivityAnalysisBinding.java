...
public final class ActivityAnalysisBinding implements ViewBinding {
  ...
  private ActivityAnalysisBinding(@NonNull CoordinatorLayout rootView, @NonNull Toolbar toolbar) {
  ...
  public static ActivityAnalysisBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAnalysisBinding((CoordinatorLayout) rootView, toolbar);
    }
